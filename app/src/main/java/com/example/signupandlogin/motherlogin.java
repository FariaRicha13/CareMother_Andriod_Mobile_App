...
public class motherlogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_motherlogin);
                ...
                fAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            Toast.makeText(motherlogin.this, "Logged in Successfully!!", Toast.LENGTH_SHORT).show();

                          startActivity(new Intent(getApplicationContext(),Mother.class));
                            ...
                            Toast.makeText(motherlogin.this, "Error Logging In"+task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });

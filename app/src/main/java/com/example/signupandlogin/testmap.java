...
public class testmap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(new Runnable() {
            ...
            @Override
            public void run() {
                Intent intent = new Intent(testmap.this, Mother.class);
                          ...
                          /*  FirebaseDatabase.getInstance().getReference("Current Location")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText( testmap.this,"Location Saved", Toast.LENGTH_SHORT).show();}
                                    else
                                    {Toast.makeText(testmap.this,"Location Not Saved", Toast.LENGTH_SHORT).show();

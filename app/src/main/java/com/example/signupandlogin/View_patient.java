...
public class View_patient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myArrayAdapter = new ArrayAdapter<String>( View_patient.this,android.R.layout.simple_list_item_1,myArrayList);
      ...
      /*  ref.addChildEventListener(new ChildEventListener() {
        ...
        myListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent( View_patient.this, Mother_profile4.class);

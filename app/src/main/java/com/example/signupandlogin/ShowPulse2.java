...
public class ShowPulse2 extends AppCompatActivity {
    public static final String CHANNEL_ID = "10001" ;
    private final static String default_channel_id = "default";
    ListView myListView;
    DatabaseReference refp,reft,ref1,ref2,ref,refstore,refw,refu,reffrnd;
...
int countP=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_pulse2);
        ...
        userQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot foodSnapshot : snapshot.getChildren()) {
                    ...
                    refp.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            SharedPreferences myPreferences
                                    = PreferenceManager.getDefaultSharedPreferences(ShowPulse2.this);
                    ...
                    NotificationCompat.Builder builder = new NotificationCompat.Builder(ShowPulse2.this, CHANNEL_ID)
                    ...
                    NotificationManagerCompat notificationManager = NotificationManagerCompat.from(ShowPulse2.this);
                    ...
                    new android.os.Handler().postDelayed(
                            new Runnable() {
                                public void run() {
                                    ...
                                    startService(new Intent(ShowPulse2.this, NewService.class));
                                }
                            }, 5000);
                }

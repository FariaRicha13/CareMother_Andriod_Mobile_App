...
public class caretaker_signup2 extends AppCompatActivity {
    FirebaseDatabase database;
    DatabaseReference ref;
    private Button buttonsignup;
    CaretakerMember caretaker;
   ...
   // MotherMember mother;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caretaker_signup2);

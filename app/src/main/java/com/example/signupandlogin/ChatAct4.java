...
public class ChatAct4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_act4);
        ...
        mUser=mUser1.getUid();
        mUserref= FirebaseDatabase.getInstance().getReference().child("caretaker");
        otheruseref= FirebaseDatabase.getInstance().getReference("User");
    ...
    private void sendSMS() {
        ...
        if(sms.isEmpty())
        {
            Toast.makeText(ChatAct4.this,"Please Write Something",Toast.LENGTH_SHORT).show();
        }
        else
        {
                ...
                public void onSuccess(Void aVoid) {
                    ...
                    smsref.child(recieverroom).push().setValue(model).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(ChatAct4.this,"Message Sent",Toast.LENGTH_SHORT).show();
                            insms.setText(null);
                        }
                    });
                }
    ...
    private void LoadOtherUser() {
        otheruseref.child(otheruser).addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ChatAct4.this,""+error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });

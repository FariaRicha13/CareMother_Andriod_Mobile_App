...
public class Mother_profile3 extends AppCompatActivity {
    ListView myListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.activity_mother_profile3);
 ...
 chat.setOnClickListener(new View.OnClickListener() {
    ...
    private void openChat() {
        Intent intent = new Intent(Mother_profile3.this, ChatAct2.class);
         Log.wtf("User",User);

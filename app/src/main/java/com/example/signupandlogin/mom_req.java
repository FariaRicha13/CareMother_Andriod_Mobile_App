...
public class mom_req extends AppCompatActivity {
    ListView myListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mom_req);
        ArrayAdapter<String> myArrayAdapter = new ArrayAdapter<String>(mom_req.this, android.R.layout.simple_list_item_1, myArrayList);
        ...
        docid1=map.getDocid();
        ref= FirebaseDatabase.getInstance().getReference("caretaker_req");
        ...
        ref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                for(DataSnapshot snapshot1: snapshot.getChildren())
                {
                    ...
                    Log.wtf("pif", v);
                    Query userQuery = FirebaseDatabase.getInstance().getReference().child("caretaker_req").child(v).orderByChild("mother");
                    ref3=FirebaseDatabase.getInstance().getReference("caretaker_req").child(v).child(docid).child("cartaker");
                    ...
                    userQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            for (DataSnapshot foodSnapshot : snapshot.getChildren()) {
                                ...
                                Log.wtf("key", key);
                                m = (String) foodSnapshot.child("caretaker").getValue();
                            ...
                            ref2 = FirebaseDatabase.getInstance().getReference("caretaker").child(m);
      ...
      /*  ref2=FirebaseDatabase.getInstance().getReference("User").child(v);
        ...
        myListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(mom_req.this, caretaker_profile2.class);

...
public class ReportForDoc extends AppCompatActivity {
    ...
    String User,key;
    String mom,val;
    DatabaseReference ref, ref2, ref3, ref4, ref5, ref6,refuser,reffrnd,ref1;
    Integer a,b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_for_doc);
     ...
     //   reffrnd =  FirebaseDatabase.getInstance().getReference("friends").child(pname);

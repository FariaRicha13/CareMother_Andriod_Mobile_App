...
public class ChatAct2 extends AppCompatActivity {
...
String sendUrl="https://fcm.googleapis.com/fcm/send";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_act2);
        ...
        mUser=mUser1.getUid();
        mUserref= FirebaseDatabase.getInstance().getReference().child("doctor");
    ...
    private void sendSMS() {
        ...
        if(sms.isEmpty())
        {
            Toast.makeText(ChatAct2.this,"Please Write Something",Toast.LENGTH_SHORT).show();
        }
        else
        {
                ...
                public void onSuccess(Void aVoid) {
                    ...
                    smsref.child(recieverroom).push().setValue(model).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(ChatAct2.this,"Message Sent",Toast.LENGTH_SHORT).show();
                            insms.setText(null);
                        }
                    });
                }
    ...
    private void LoadOtherUser() {
        otheruseref.child(otheruser).addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ChatAct2.this,""+error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });

...
public class doctor_profile2 extends AppCompatActivity {
   ...
   // DatabaseReference pname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myArrayAdapter = new ArrayAdapter<String>(doctor_profile2.this,android.R.layout.simple_list_item_1,myArrayList);
                            ...
                            public void onClick(View v) {
                                    ...
                                    reqref.child(username1).child(key).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener() {
                                        ...
                                        public void onComplete(@NonNull Task task) {
                                            ...
                                            if (task.isSuccessful()) {
                                                Toast.makeText(doctor_profile2.this, "Request has been sent", Toast.LENGTH_SHORT).show();
                                                ...
                                                Toast.makeText(doctor_profile2.this, "" + task.getException().toString(), Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                                }
                                if (current_state.equals("pending") || current_state.equals("declined")) {
                                    reqref.child(username1).child(key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                Toast.makeText(doctor_profile2.this, "Request Cancelled", Toast.LENGTH_SHORT).show();
                                ...
                                if (current_state.equals("connected")) {
                                    ...
                                    frndref.child(username1).child(key).updateChildren(hashMap1).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
                                            Toast.makeText(doctor_profile2.this, "Friends", Toast.LENGTH_SHORT).show();
                                            //reqref.child(username1).child(key);
                                            ...
                                            connect.setOnClickListener(new View.OnClickListener() {
                                                @Override
                                                public void onClick(View v) {
                                                    Intent intent = new Intent(doctor_profile2.this, ChatAct.class);
                        ...
                        decline.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                frndref.child(username1).child(key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        Toast.makeText(doctor_profile2.this, "Disconnected", Toast.LENGTH_SHORT).show();

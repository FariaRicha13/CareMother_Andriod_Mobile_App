...
chat model=new chat();
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // recyclerView.setLayoutManager(new LinearLayoutManager(this));
        ...
        otheruseref= FirebaseDatabase.getInstance().getReference("doctor");
    ...
    private void sendSMS() {
        ...
        if(sms.isEmpty())
        {
            Toast.makeText(ChatAct.this,"Please Write Something",Toast.LENGTH_SHORT).show();
        }
        else
        {
    ...
    private void LoadOtherUser() {
        otheruseref.child(otheruser).addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ChatAct.this,""+error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });

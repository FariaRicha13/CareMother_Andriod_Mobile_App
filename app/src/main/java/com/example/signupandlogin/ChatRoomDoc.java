...
public class ChatRoomDoc extends AppCompatActivity {
    ListView myListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_room_doc);
        ArrayAdapter<String> myArrayAdapter = new ArrayAdapter<String>( ChatRoomDoc.this,android.R.layout.simple_list_item_1,myArrayList);
      ...
      /*  ref.addChildEventListener(new ChildEventListener() {
        ...
        myListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent( ChatRoomDoc.this, Mother_profile3.class);

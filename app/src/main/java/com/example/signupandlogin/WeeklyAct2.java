...
public class WeeklyAct2 extends AppCompatActivity {
    ...
    Date dob1;
String mom,val;
    DatabaseReference ref, ref2, ref3, ref4, ref5, ref6,refuser,reffrnd;
    Integer a,b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weekly_act2);
        ...
        userQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot foodSnapshot : snapshot.getChildren()) {
                    ...
                    Log.w("Mother", val);
                    ref = FirebaseDatabase.getInstance().getReference("User").child(val);

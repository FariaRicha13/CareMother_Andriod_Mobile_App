...
public class BpShow extends AppCompatActivity {
    ListView myListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bp_show);
                    ...
                    reft.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            SharedPreferences myPreferences
                                    = PreferenceManager.getDefaultSharedPreferences(BpShow.this);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(BpShow.this, CHANNEL_ID)
        ...
        NotificationManagerCompat notificationManager = NotificationManagerCompat.from(BpShow.this);
        ...
        new android.os.Handler().postDelayed(
                new Runnable() {
                    public void run() {
                        ...
                        startService(new Intent( BpShow.this, NewService.class ) );
                    }
                }, 5000);

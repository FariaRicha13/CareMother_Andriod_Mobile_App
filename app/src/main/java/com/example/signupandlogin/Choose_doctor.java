...
public class Choose_doctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myArrayAdapter = new ArrayAdapter<String>(Choose_doctor.this,android.R.layout.simple_list_item_1,myArrayList);
        ...
        myListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               // Toast.makeText(context,"selected",Toast.LENGTH_LONG).show();
                Intent intent = new Intent(Choose_doctor.this, doctor_profile2.class);

...
public class caretaker_profile3 extends AppCompatActivity {
    ListView myListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caretaker_profile3);
        ArrayAdapter<String> myArrayAdapter = new ArrayAdapter<String>(caretaker_profile3.this,android.R.layout.simple_list_item_1,myArrayList);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        connect.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent = new Intent(caretaker_profile3.this, ChatAct3.class);
